...
/// Base Physical Address of the ARM Timer peripheral
#define BCM2835_TIMER_ARM_BASE	(BCM2835_PERI_BASE + 0x00B000)
 ...
 */
#define BCM2835_BSC0_C		*(bsc0.addr + 0x00)
#define BCM2835_BSC0_S		*(bsc0.addr + 0x01)
#define BCM2835_BSC0_DLEN	*(bsc0.addr + 0x02)
#define BCM2835_BSC0_A		*(bsc0.addr + 0x03)
#define BCM2835_BSC0_FIFO	*(bsc0.addr + 0x04)
...
#define BCM2835_START_READ	BCM2835_BSC_C_I2CEN|BCM2835_BSC_C_ST|BCM2835_BSC_C_CLEAR_1|BCM2835_BSC_C_READ
#define BCM2835_START_WRITE	BCM2835_BSC_C_I2CEN|BCM2835_BSC_C_ST

#define BCM2835_CLEAR_STATUS	BCM2835_BSC_S_CLKT|BCM2835_BSC_S_ERR|BCM2835_BSC_S_DONE
...
extern "C" {
	...
	/// Shows the state of the GPIO pins
	extern void bcm2835_gpio_show_pins(uint8_t watched_pin);
